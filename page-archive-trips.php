...
<?php get_header(); ?>
    ...
    <div class="container">
        ...
        <h2 class="main-title">Past Trips</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="content">
                        ...
                        <?php echo do_shortcode('[ajax_load_more loading_style="light-grey" container_type="div"  post_type="events" posts_per_page="6" category__and="8,9" meta_key="date" meta_value="date("dmY")" meta_compare="&gt;=" order_by="meta_value" order="DSC" scroll="false" ajax_load_more id="diary" category__not_in="6" button_label="Load more"]');?>
